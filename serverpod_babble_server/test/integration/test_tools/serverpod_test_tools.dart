...
import 'package:serverpod_babble_server/src/generated/channel.dart' as _i4;
import 'package:serverpod_babble_server/src/generated/protocol.dart';
import 'package:serverpod_babble_server/src/generated/endpoints.dart';
...
class _ThemeEndpoint {
  ...
  _i3.Future<void> changeTheme(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'theme',
